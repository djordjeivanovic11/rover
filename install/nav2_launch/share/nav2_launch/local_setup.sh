...
: ${AMENT_CURRENT_PREFIX:="/home/rover/workspaces/rover-real/src/install/nav2_launch"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_launch/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_launch/environment/path.sh"
